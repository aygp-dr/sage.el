#+TITLE: Sage - AI REPL for Emacs - Usage Guide
#+AUTHOR: Jason Walsh
#+EMAIL: j@wal.sh

* Introduction

This guide demonstrates practical usage patterns for =sage.el= and =sage-emacs.el=, showing how to integrate AI assistance into your Emacs workflow.
...
Then run =M-x sage-org-process-ai-blocks= to process all AI blocks.
...
(defun my-sage-set-project-context ()
...
- Keep =sage-yolo-mode= off in production
...
** With LSP Mode
#+begin_src elisp
(defun my-sage-explain-diagnostic ()
...
** With Projectile
#+begin_src elisp
(defun my-sage-project-overview ()
