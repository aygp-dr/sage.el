...
| git_status         | magit (required)  | No              | ✅ Magit only   |
| git_diff           | magit (required)  | No              | ✅ Magit only   |
| git_log            | magit (required)  | No              | ✅ Magit only   |
| git_branch         | magit (required)  | No              | ✅ Magit only   |
| git_blame          | magit (required)  | No              | ✅ Magit only   |
...
| org_todo_list      | Emacs native      | No              | ✅ Good         |
| org_add_todo       | Emacs native      | No              | ✅ Good         |
| org_set_todo_state | Emacs native      | No              | ✅ Good         |
| web_fetch          | Emacs native      | No              | ✅ Good         |
| web_search         | Emacs native      | No              | ✅ Good         |
